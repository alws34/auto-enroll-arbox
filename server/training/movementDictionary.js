...
const MOVEMENTS = [
	...
	{ keywords: ["clean"], groups: ["lower-back", "hamstring", "quadriceps", "gluteal", "trapezius", "front-deltoids", "abs", "forearm"] },
	{ keywords: ["snatch"], groups: ["lower-back", "hamstring", "quadriceps", "gluteal", "trapezius", "front-deltoids", "abs", "forearm"] },
	...
	{ keywords: ["kb swing", "kettlebell swing", "swing"], groups: ["gluteal", "hamstring", "lower-back", "forearm"] },
	{ keywords: ["american kb swing", "american swing", "american kettlebell swing"], groups: ["front-deltoids"] },
	...
	{ keywords: ["toes-to-bar", "toes to bar", "t2b"], groups: ["abs", "forearm"] },
	{ keywords: ["knees-to-elbows", "knees to elbows", "k2e"], groups: ["abs", "forearm", "upper-back"] },
	{ keywords: ["handstand walk", "hs walk", "h.s walk"], groups: ["front-deltoids", "triceps", "abs"] },
